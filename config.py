...
class Config:
  ...
  if ENV:
    ...
    BOT_TOKEN = '2068009364:AAHIqtFgdroG9I7kHo3GYujUjBKcTDyzyQw' # Get it from https://t.me/BotFather
    APP_ID = '8755370' # Get it from my.telegram.org/apps
    API_HASH = '54261233493bbc5bbf489146dd2909dc' # Get it from my.telegram.org/apps
